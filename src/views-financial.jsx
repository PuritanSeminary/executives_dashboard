  ...
  return (
    <>
      <Brief
        ...
        headline="Financial"
        dek="Statement of Activities · FY 2025–26, synced from Financial Edge NXT."
        sources={[
          { label: 'Source', value: 'Financial Edge NXT' },
          { label: 'Refresh', value: 'Monthly' },
          { label: 'Fiscal year', value: 'May 2025 – Apr 2026' },
        ]}
      />
      ...
      <div className="card">
        <div className="card__hd">
          <div>
            ...
            <div className="card__sub">Monthly actuals against the even split of the annual budget. The partial current month is hidden unless the range is MTD. Click a department below to swap the series.</div>
          </div>
        ...
        <div className="card span-8">
          <div className="card__hd">
            <div>
              ...
              <div className="card__sub">YTD spend versus the budget for the same {F.ytd.elapsedMonths} months. Click any row to chart the department above.</div>
            </div>
      ...
      <div className="card">
        <div className="card__hd">
          <div>
            <h3 className="card__title">Statement of activities</h3>
            <div className="card__sub">Revenue, expense and net surplus — actual against the budget for the period. {p === 'ytd' ? 'Fiscal year to date through Apr 2026.' : 'Month of April 2026.'}</div>
          </div>
          <div className="chart-toggle">
      ...
      <div className="grid grid--12">
        <div className="card span-6">
          <div className="card__hd">
            <div>
              <h3 className="card__title">Revenue by fund · YTD</h3>
              <div className="card__sub">Actual against prior year. {fmt.shortMoney(F.byFund.revenueTotal.actual)} total.</div>
            </div>
          </div>
          <table className="tbl">
            <thead>
        ...
        <div className="card span-6">
          <div className="card__hd">
            <div>
              <h3 className="card__title">Expense by fund · YTD</h3>
              <div className="card__sub">Actual against prior year. {fmt.shortMoney(F.byFund.expenseTotal.actual)} total.</div>
            </div>
          </div>
          <table className="tbl">
            <thead>
