  ...
  return (
    <>
      <Brief
        ...
        headline="Donations"
        dek="Synced from Raiser's Edge NXT."
        sources={[
        { label: 'Source', value: "Raiser's Edge NXT" },
        { label: 'Refresh', value: 'Monthly' },
        { label: 'Lead', value: 'Karla Soule, VP Adv.' }]
        } />
      ...
      <div className="card">
        <div className="card__hd">
          <div>
            ...
            <div className="card__sub">Trailing twelve months by gift date · {fmt.shortMoney(givingTotal)} total. The current partial month is excluded. Click any fund chip to filter.</div>
          </div>
          {fundFilter &&
