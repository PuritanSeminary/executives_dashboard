...
// Expense cost centres as on the report's Statement of Activities (FY2026,
// all funds). Actual / budget / prior-year plus current-month.
const DEPARTMENTS = [
  { id: 'academics',  name: 'Academics',        head: 'Dr. Bilkes',     ytdActual: 2_422_765, ytdBudget: 2_514_076, priorYear: 2_177_174, mtdActual: 216_027, mtdBudget: 228_608 },
  { id: 'admin',      name: 'Administration',   head: 'Dr. Neele',      ytdActual: 1_569_924, ytdBudget: 1_649_586, priorYear: 1_466_843, mtdActual: 137_707, mtdBudget: 153_506 },
  { id: 'bookstore',  name: 'Bookstore',        head: 'Bill Thies',     ytdActual:   111_913, ytdBudget:   115_060, priorYear:   107_037, mtdActual:   8_823, mtdBudget:  10_460 },
  { id: 'chancellor', name: 'Chancellor',       head: 'Dr. Beeke',      ytdActual:   464_737, ytdBudget:   454_572, priorYear:   401_242, mtdActual:  40_851, mtdBudget:  39_052 },
  { id: 'facilities', name: 'Facilities',       head: 'Bill Thies',     ytdActual:   310_691, ytdBudget:   270_709, priorYear:   390_766, mtdActual:  30_109, mtdBudget:  25_519 },
  { id: 'tech',       name: 'Information Tech', head: 'Seth Huckstead', ytdActual:   643_662, ytdBudget:   626_472, priorYear:   562_863, mtdActual:  43_707, mtdBudget:  56_952 },
  { id: 'philanthropy', name: 'Philanthropy',   head: 'Karla Soule',    ytdActual:   185_809, ytdBudget:   251_471, priorYear:   192_738, mtdActual:  11_732, mtdBudget:  22_861 },
  { id: 'projects',   name: 'Projects & Comm',  head: 'Jo DeBlois',     ytdActual:   957_367, ytdBudget:   781_691, priorYear:   867_690, mtdActual:  74_289, mtdBudget:  67_881 },
];
...
// Investments — asset-class composition exactly as shown on the Financial
// Summary report (page 2). Total ties to the balance sheet ($13.21M).
finance.investments = {
  asOf: 'Apr 30, 2026',
  composition: [
  ...
  accounts: [
    { name: 'Equities',         balance: 6_500_000, share: 0.49 },
    { name: 'Cash Equivalents', balance: 4_300_000, share: 0.32 },
    { name: 'Fixed Income',     balance: 2_412_516, share: 0.18 },
  ],
};
...
// (Per-holding returns aren't in the custodial roll; the portfolio YTD return
// is carried as a stated figure.)
finance.investments.ytdWeighted = 0.062;
...
finance.ytd = {
  spend: 6_666_869, budget: 6_663_637, priorYear: 6_166_354,
  elapsedMonths: 12, monthLabel: 'FY 2026',
};
finance.ytd.variance = (finance.ytd.spend - finance.ytd.budget) / finance.ytd.budget;

finance.mtd = {
  spend: 563_246, budget: 604_839, priorYear: 570_534,
  monthlyBudget: finance.monthlyBudget, monthLabel: 'current month',
};
...
finance.revenue = {
  ytd: { actual: 8_730_863, budget: 8_779_316, priorYear: 7_817_923 },
  mtd: { actual:   327_715, budget:   300_771, priorYear:   257_766 },
  categories: [
    { name: 'Donations',   ytdActual: 5_912_762, ytdBudget: 5_825_310, priorYear: 5_830_896, mtdActual: 195_056, mtdBudget:  73_054 },
    { name: 'Grants',      ytdActual: 1_335_085, ytdBudget: 1_428_574, priorYear:   694_382, mtdActual:       0, mtdBudget:  71_429 },
    { name: 'Tuition',     ytdActual: 1_029_981, ytdBudget: 1_085_543, priorYear:   865_586, mtdActual:  95_069, mtdBudget: 117_000 },
    { name: 'Rental',      ytdActual:   274_717, ytdBudget:   274_582, priorYear:   251_415, mtdActual:  25_781, mtdBudget:  24_962 },
    { name: 'Bookstore',   ytdActual:   131_361, ytdBudget:   124_586, priorYear:   107_610, mtdActual:  11_691, mtdBudget:  11_326 },
    { name: 'Other',       ytdActual:    40_446, ytdBudget:    40_721, priorYear:    17_008, mtdActual:     118, mtdBudget:   3_000 },
    { name: 'Investments', ytdActual:     6_511, ytdBudget:         0, priorYear:    51_026, mtdActual:       0, mtdBudget:       0 },
  ],
};
...
// Net surplus / (deficit).
finance.net = {
  ytd: { actual: 2_063_995, budget: 2_115_679, priorYear: 1_651_569 },
  mtd: { actual:  -235_531, budget:  -304_068, priorYear:  -312_765 },
};
...
// By fund restriction, from the Statement of Activities (FY2026). Actual only
// (the report doesn't break restriction out by prior year).
finance.byFund = {
  revenue: [
    { name: 'Unrestricted', actual: 7_033_127 },
    { name: 'Restricted',   actual: 1_697_736 },
  ],
  revenueTotal: { actual: 8_730_863 },
  expense: [
    { name: 'Unrestricted', actual: 4_901_830 },
    { name: 'Restricted',   actual: 1_765_039 },
  ],
  expenseTotal: { actual: 6_666_869 },
  net: { actual: 2_063_995 },
};
